...
inline void ImResize(float* Img, int width, int height, float* Rimg, int Rwidth, int Rheight){
	int x, y, index;
	float fx, fy;
...
inline void ImChopping(float* Img, int width, int height, float* Rimg, int Rwidth, int Rheight){
...
inline void ImChopping(float* Img, int width, int height, float* Rimg, int Rwidth, int Rheight, int CenterX, int CenterY){
	int x,y, index, lindex;
